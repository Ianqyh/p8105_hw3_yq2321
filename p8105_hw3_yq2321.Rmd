...
NY_data_value_2010 = brfss_smart_cleaned %>%
  ...
  ggplot(aes(x = data_value, fill = response)) +
  geom_density(alpha = .4) + labs(title = "2010")
...
The table above shows the total activity for each day. We can see that the total activity generally remains high and stable over time, except for a few days when it drastically decreases, for example, day 2, day 24, and day 24.
≥
